...
from ....common.schemas.request import SessionInfobaseList
from .prometheus_metrics import labels_list, metrics_list


def get_session_list_infobase(req: SessionInfobaseList, prometheus: bool = False):
    try:
        rac = RasInterface(req=req)
        session_all = rac.java_get_infobase_sessions()
        rac.close()
