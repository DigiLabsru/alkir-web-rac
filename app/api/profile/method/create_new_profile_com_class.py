...
from ....common.schemas.request import NewSecurityProfileCOMClass


def create_new_profile_com_class(req: NewSecurityProfileCOMClass):
    try:
        ...
        new_object = rac.java_create_security_profile_com_class(property=req)
        rac_data = rac.java_get_security_profile_com_classes(sp_name=req.sp_name)
        rac.close()
