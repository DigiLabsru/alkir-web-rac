...
from ....common.schemas.request import NewSecurityProfileAddIn


def create_new_profile_add_in(req: NewSecurityProfileAddIn):
    try:
        ...
        new_object = rac.java_create_security_profile_add_in(property=req)
        rac_data = rac.java_get_security_profile_add_ins(sp_name=req.sp_name)
        rac.close()
