...
from ....common.schemas.request import SecurityProfileDropInfoExtVD


def remove_profile_virtual_directory(req: SecurityProfileDropInfoExtVD):
    try:
        ...
        rac.java_drop_security_profile_virtual_directory(sp_name=req.sp_name, alias=req.alias)
        rac_data = rac.java_get_security_profile_virtual_directories(sp_name=req.sp_name)
        rac.close()
