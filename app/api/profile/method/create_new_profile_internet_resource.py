...
from ....common.schemas.request import NewSecurityProfileInternetResource


def create_new_profile_internet_resource(req: NewSecurityProfileInternetResource):
    try:
        ...
        new_object = rac.java_create_security_profile_internet_resource(property=req)
        rac_data = rac.java_get_security_profile_internet_resources(sp_name=req.sp_name)
        rac.close()
